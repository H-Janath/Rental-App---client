...
const Navbar = () => {
  ...
  console.log("Auth user role", authUser)
    ...
    >
      <div className="flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white">
        ...
        {!isDashboardPage &&(<p className="text-primary-200 hidden md:block">
          Discover your perfect rental aprtment with our advanced search 
        </p>)}
        <div className="flex items-center gap-3">
         {authUser?(
          <>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap2 focuse:outline-none">
              <Avatar>
          ...
          <><Link href='/signin'>
            <Button variant="outline"
              className="text-white border-white bg-trnasparent hover:bg-white hover:text-primary-700 rounded-lg"
